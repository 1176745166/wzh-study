package com.wzh.security.utils;
...
public class SecurityUtils
{
   ...
   private ISysRoleService iSysRoleService;
    ...
    public static String getUsername()
    {
        ...
        {
            throw new ServiceException("获取用户名异常", HttpStatus.UNAUTHORIZED.value());
        }
    }
    ...
    public static boolean hasPermi(Collection<String> authorities, String permission)
    {
        return authorities.stream().filter(StringUtils::hasText)
                .anyMatch(x -> "admin".equals(x) || PatternMatchUtils.simpleMatch(x, permission));
    }
    ...
    public static boolean hasRole(Collection<String> roles, String role)
    {
        return roles.stream().filter(StringUtils::hasText)
                .anyMatch(x -> "admin".equals(x) || PatternMatchUtils.simpleMatch(x, role));
    }
